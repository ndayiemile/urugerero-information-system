  ...
  <div class="mt-2 card border-0">
    <div class="tab-content card-body">
      ...
      <div class="tab-pane active" id="activity" role="tabpanel" aria-labelledby="activity-tab">
        <form class="m-auto col-8" action="" method="post" id="activityRegistrationForm">
          <!-- title -->
          ...
          <div class="form-floating mb-3">
            <input type="text" class="form-control" name="description" id="formId1" placeholder="" />
            <label for="formId1">description:</label>
          </div>
          <!-- pictures  -->
          <div class="mb-3">
            <label for="" class="form-label">Pictures:</label>
            <input type="file" accept=".jpg, .png, .jiff, .jpeg" class="form-control" name="pictures" id="" placeholder="" aria-describedby="fileHelpId" multiple />
