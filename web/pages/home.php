          ...
          <div class="row g-3">
            <div class="col-6">
              <div class="card border-0 shadow-sm">
                ...
                >
                  <div
                    class="bg-light-green p-3 me-2 me-md-4 rounded-circle d-flex align-items-center"
                  >
                    <svg
                      ...
                      height="36"
                      fill="currentColor"
                      class="text-medium-green bi bi-people-fill"
                      viewBox="0 0 16 16"
                    >
                      <path
                  ...
                  <div
                    class="ms-lg-2 d-flex flex-column justify-content-center"
                  >
                    <p class="m-0 p-0 fs-6 text-secondary fw-light">
                      Total number of<br />
                      Intore
                    </p>
                    <p class="m-0 p-0 fs-6 fw-bolder">578</p>
                  </div>
                </div>
            ...
            <div class="col-6">
              <div class="card border-0 shadow-sm">
                ...
                >
                  <div
                    class="bg-light-blue p-3 me-2 me-md-4 rounded-circle d-flex align-items-center"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="36"
                      height="36"
                      fill="currentColor"
                      class="text-medium-blue bi bi-ui-checks"
                      viewBox="0 0 16 16"
                    >
                      <path
              ...
              <div class="card shadow-sm border-0 pt-2 px-2">
                <div class="card-header bg-white border-4 border-medium-green">
                  <div class="text-solid-blue text-center">
                    <h5 class="m-0">Pending Activities</h5>
                  </div>
                </div>
                <div class="card-body pb-0 px-0">
                  <div class="card border-0 shadow-sm p-2 mb-2">
                    <div
                      class="card-header bg-white border-0 d-flex justify-content-between p-0"
                    >
                      <span class="gs-fs-7 text-solid-gray"
                        >Title of Activity</span
                      ><small class="gs-fs-8 text-solid-pink">Sept 1</small>
                    </div>
              ...
              <div class="card shadow-sm border-0 pt-2 px-2">
                ...
                <div class="card-body pb-0 ps-3 pe-0">
                  <div class="timeline scroll-y position-relative ps-2 pb-0">
                    ...
                    >
                      <div
                        class="card-header fw-bolder border-0 bg-white p-0 d-flex justify-content-between p-2"
                      >
                      ...
                      >
                        <div
                          class="text-white h-100 ps-2 d-flex align-items-center"
                        >
