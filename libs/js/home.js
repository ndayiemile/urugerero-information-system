window.onload = () => {
  ...
  server(getNumberOfActivitiesAndRegisteredIntore,"getNumberOfActivitiesAndRegisteredIntore",formData)
  // render graphs
  analyticsGraphs(ApexCharts)
}
// render all graphs on the Dashboard UI
function analyticsGraphs(ApexCharts) {
