  ...
  <body class="bg-light">
    ...
    <main class="px-3">
      ...
      <section class="mt-3 rounded d-flex justify-content-between align-items-center">
        <p class="m-0 fs-7 fw-light">Inkomezabogwi ikiciro cya 11 / <span>Kimisagara</span></p>
        <button class="btn btn-sm btn-info border-0 shadow-sm bg-light-green">+Register Intore</button>
      </section>
