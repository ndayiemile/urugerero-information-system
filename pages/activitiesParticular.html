...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../libs/css/activitiesParticularStyle.css" />
    <!-- scripts -->
    <script
    ...
    <main class="px-3">
      ...
      <section class="mt-3 rounded bg-white">
        <div class="card border-0">
          ...
          <div class="card-body border mx-3 mb-3">
            <div class="mt-4">
              <div class="d-flex justify-content-between">
                <p class="fs-4">
                  <span class="fw-bold me-2">Title:</span
                  ><span>kubaka amazu yabayobozi</span>
                </p>
                <span>sept 3</span>
              </div>

              <p class="mb-2">
                <span class="fw-bold">Bikozwe na:</span
                ><span>Kamuhoza, group B</span>
              </p>
              <div class="d-flex">
                <p class="fw-bold">Twifatanije na:</p>
                <ul>
                  <li>dEO wa karere ka NYARUGENGE</li>
                  <li>CEO wa Kamuhoza</li>
                </ul>
              </div>
              <p>
                <span>Bikorewe Kwa:</span
                ><span>papa Danny Isimbi, kimisagara</span>
              </p>
              <p>
                ...
                consequatur ullam ea rerum.
              </p>
            </div>
            <div class="activity-img-container row mt-2 g-1">
                <div class="col-6 col-md-3">
                    <img class="img-fluid" src="../dipository/pictures/Activities/WhatsApp Image 2023-10-19 at 12.28.59.jpeg" alt="" srcset="">
                </div>
                <div class="col-6 col-md-3">
                    <img class="img-fluid" src="../dipository/pictures/Activities/WhatsApp Image 2023-10-19 at 12.28.59.jpeg" alt="" srcset="">
                </div>
