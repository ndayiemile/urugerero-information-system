...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="../build/bootstrap-5.3.2-dist/css/bootstrap.min.css"
    />
    ...
    <script
      type="text/javascript"
      src="../build/bootstrap-5.3.2-dist/js/bootstrap.bundle.js"
      defer
    ></script>
    <script
      type="text/javascript"
  ...
  <body class="bg-light">
    ...
    <main class="px-3">
      ...
      <section
        class="mt-3 rounded d-flex justify-content-between align-items-center"
      >
          ...
          <div class="card-header border-0 bg-white px-0 pb-0 pt-3">
            <div class="px-3 pb-2 d-flex align-items-center">
              ...
              >
                ...
                <option value="school">Attendance</option>
                <option value="combination">Combination</option>
              </select>
              <!-- assign a task -->
              <div class="dropdown open">
                <a
                  class="px-2 text-decoration-none bg-white border rounded-0 dropdown-toggle p-0 text-dark"
                  type="button"
                  id="triggerId"
                ...
                <div class="dropdown-menu" aria-labelledby="triggerId">
                  ...
                  <a class="dropdown-item disabled" href="#">Honor</a>
                  <a class="dropdown-item disabled" href="#">Permission</a>
                  <a class="dropdown-item disabled" href="#">Misconduct</a>
                  <a class="dropdown-item disabled" href="#">Responsibility</a>
                </div>
              </div>
            ...
            <div
              class="px-3 py-2 bg-light-gray d-flex align-items-center justify-content-between"
            >
              <div class="col-2">
                <div class="d-flex align-items-baseline">
                  <input
                    type="checkbox"
                    class="mt-2 form-check-input fs-5 rounded-0"
                  />
                  <span class="m-0 p-0 ms-4">All</span>
                </div>
              </div>
              <div class="col-2">
                <div class="d-flex align-items-baseline">
                  <input
                    type="checkbox"
                    class="mt-2 form-check-input fs-5 rounded-0 invisible"
                  />
                  <span class="m-0 p-0 ms-2">Inactive</span>
                </div>
              </div>
              <div class="col-2">
                <div class="d-flex align-items-baseline">
                  <input
                    ...
                    class="mt-2 form-check-input fs-5 rounded-0 invisible"
                  />
                  <span class="m-0 p-0 ms-2">Sick</span>
                </div>
              </div>
              <div class="col-2">
                <div class="d-flex align-items-baseline">
                  <input
                    ...
                    class="mt-2 form-check-input fs-5 rounded-0 invisible"
                  />
                  <span class="m-0 p-0 ms-2">Employed</span>
                </div>
              </div>
              <div class="col-2">
                <div class="d-flex align-items-baseline">
                  <input
                    ...
                    class="mt-2 form-check-input fs-5 rounded-0 invisible"
                  />
                  <span class="m-0 p-0 ms-2">Studying</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="table-responsive">
              <table class="table">
                ...
                <tr>
                  ...
                  <td>
                    <div class="float-end">
                      <span class="badge bg-danger-subtle">sick</span>
                      <div
                        class="ms-3 btn-group"
                        role="group"
                        aria-label="btngroup"
                ...
                <tr>
                  ...
                  <td>
                    <div class="float-end">
                      <span class="badge bg-info-subtle">Employed</span>
                      <div
                        class="ms-3 btn-group"
                        role="group"
                        aria-label="btngroup"
                ...
                <tr>
                  ...
                  <td>
                    <div class="float-end">
                      <span class="ms-auto badge bg-warning-subtle">Task</span>
                      <div
                        class="ms-3 btn-group"
                        role="group"
                        aria-label="btngroup"
